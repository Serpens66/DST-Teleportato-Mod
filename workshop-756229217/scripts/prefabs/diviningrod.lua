-- not very happy that I have to replace the file just because of a missing inst.SoundEmitter:KillSound("ping")
-- but even in modmain it would not be much easier, I only see to replace while on/unequip stuff including the whole task, so not much difference..
